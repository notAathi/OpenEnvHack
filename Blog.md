# I Built an RL Env Where the Model Has to Deal With Executive Chaos
...
I wanted to build something where the model actually has to *think*, not just pattern match on obvious signals.

so I sat down and asked myself: what does an executive assistant actually deal with every morning?
